...
document.write(word, '<br>', scool,'<br>', site,'<br>', domen, '<br>',numb1,'<br>', numb2, '<br>',numb3, '<br>',numb4, '<br>',numb5, '<br>',numb6,'<br>',numb7, '<br>',isYes,'<br>', isNo);
alert(word);
alert(scool);
alert(site);
alert(domen);
...
// let person=Name+" "+FirstName+" "+SecondName;
//
// console.log(person);
...
// let Number3= prompt ("Please enter number 3");
...
// let Number2= prompt ("Please enter number 2");
// let Number3= prompt ("Please enter number 3");
// let Number4= prompt ("Please enter number 4");
...
// let Number1= parseFloat(prompt ("Please enter number 1"));
// let Number2= parseFloat (prompt("Please enter number 2"));
// let Number3= parseFloat(prompt ("Please enter number 3"));
//
// console.log (Math.round(Number1+Number2+Number3));
...
// let Number1= Math.round(+(prompt ("Please enter number 1")));
// let Number2= Math.round(+(prompt("Please enter number 2")));
...
// console.log (10 == 10, "true");console.log(132 > 100 && 45 < 12 );
...
//	alert (`Good afternoon ${Name} ${Surname}, my wishes, that you are ${Age} old`);
